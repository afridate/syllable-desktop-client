...
socket.onmessage = (event) => {
    ...
    console.log("Получили песню:", songData);

    setupSong(songData);
};

let currentSong = "vanna";
...
function setupSong(songData) {
    ...
    // Пока обложки отключены
    // coverEl.src = `data:image/jpeg;base64,${song.theme.image_base64}`;
    ...
    audioEl.src = `/audio/${currentSong}.mp3`;
